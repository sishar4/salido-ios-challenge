...
- (id)initWithNameQuery:(NSArray *)nameQuery categoryFilter:(NSArray *)categoryFilter byWinery:(BOOL)byWinery andCompletionHandler:(void (^)(NSArray *results, BOOL success))completionHandler;
